...
int ID = Integer.parseInt(request.getParameter("searchID"));//获得想要查询的ID
...
String age = "";
Boolean state = false;
String bingbianweizhi = "";
String bingbianchangdu = "";
String bankuaitezheng ="";
Double xiazhaidu = 0.0;
boolean you = false;
   ...
   // String number[] ;
    ...
    boolean has_CCTA = false;//用来检测搜寻的ID在CCTAHistory里是否有报告
         ...
         {     //检索集合CCTA中所有文档信息
             ...
             int tempID = (int)show1.get("ID");  //提取Map中字段名为ID的属性值
